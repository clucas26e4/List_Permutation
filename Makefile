...
CircularShift_R.vo : CircularShift_R.v $(OLLIBSDIR)/List_Type_more.vo List_nat.vo Perm.vo Perm_R_more.vo List_more2.vo Fun_nat.vo
CircularShift_R_solve.vo : CircularShift_R_solve.v $(OLLIBSDIR)/List_more.vo CircularShift_R.vo
genperm_R.vo : genperm_R.v $(OLLIBSDIR)/Injective.vo $(OLLIBSDIR)/List_Type.vo Perm.vo Perm_R_more.vo Perm_R_solve.vo CircularShift_R.vo CircularShift_R_solve.vo misc.vo Fun_nat.vo
