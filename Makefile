...
Perm_R.vo : Perm_R.v $(OLLIBSDIR)/Permutation_Type.vo $(OLLIBSDIR)/Bool_more.vo List_nat.vo List_more2.vo List_Type_more2.vo Fun_nat.vo Perm.vo length_lia.vo
...
CircularShift_R.vo : CircularShift_R.v $(OLLIBSDIR)/Bool_more.vo $(OLLIBSDIR)/List_Type_more.vo List_nat.vo Perm.vo Perm_R_more.vo List_more2.vo Fun_nat.vo length_lia.vo
...
Perm_solve.vo : Perm_solve.v Perm.vo List_nat.vo List_more2.vo Fun_nat.vo all_lt_solve.vo $(OLLIBSDIR)/List_more.vo
all_lt_solve.vo : all_lt_solve.v List_nat.vo List_more2.vo Fun_nat.vo Perm.vo length_lia.vo $(OLLIBSDIR)/List_more.vo
